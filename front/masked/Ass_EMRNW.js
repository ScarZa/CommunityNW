    ...
    this.GetEMRNWForm = function () {
        $(this.content).empty().append(
          $("<div class='row' id='cgi-post'>"
             ...
             // +"<div class= 'col-lg-2 scroll' id = 'vdate' ></ > "
          +"</div>")
            );
            ...
            $("#ass-EMR").append($("<div class='card text-white bg-info mb-3'><div class='card-header'><b>ข้อมูลทั่วไป</b></div><div id='' class='card-body'>"
                                    ...
                                    +"<div class='col-lg-4 col-md-6 col-sm-6' style='text-align:right;'><b>ใบส่งตัวหมดอายุ : </b></div><div class='row col-lg-2 col-md-6 col-sm-6' id='expire_date'> </div></div>"
